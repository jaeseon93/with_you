...
//
//import co.withyou.care.admin.adminfamily.service.FamilyService;
...
//	//서비스 신청하기 메뉴
//	@RequestMapping("familyService.do")
//	public String familyService (FamilyServiceVo familyVo) throws Exception {
//		familyService.familyResultInsert(familyVo);
//		
//		return "admin/helper/FamilyMain";
//	}
//	
//	//서비스 신청내역 메뉴
